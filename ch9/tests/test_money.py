...
class TestMoney:
    ...
    def test_franc_test_equality_one(self):
        assert Money.franc(5).equals(Franc(5, None))

    def test_franc_test_equality_two(self):
        assert not Money.franc(5).equals(Franc(6, None))
